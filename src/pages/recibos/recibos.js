...
import { Add, Loading } from '@/components/Layouts'
  ...
  return (
    ...
    <ProtectedRoute>
      ...
      <BasicLayout title='Recibos' relative onReload={onReload}>
        ...
        <ReciboLista reload={reload} onReload={onReload} recibos={recibos} onToastSuccessMod={onToastSuccessMod} onToastSuccess={onToastSuccess} onToastSuccessDel={onToastSuccessDel} />
      ...
      <BasicModal title='crear recibo' show={openForm} onClose={onOpenCloseForm}>
        <ReciboForm reload={reload} onReload={onReload} onOpenCloseForm={onOpenCloseForm} />
      </BasicModal>
